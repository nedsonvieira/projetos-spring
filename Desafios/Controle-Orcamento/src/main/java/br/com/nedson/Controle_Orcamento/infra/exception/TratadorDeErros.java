...
public class TratadorDeErros {
    ...
    public ResponseEntity tratarErroRegraDeNegocio(DespesaDuplicadaException ex) {
        return ResponseEntity.status(HttpStatus.CONFLICT).body(ex.getMessage());
    }

    @ExceptionHandler(ReceitaDuplicadaException.class)
    public ResponseEntity tratarErroRegraDeNegocio(ReceitaDuplicadaException ex) {
        return ResponseEntity.status(HttpStatus.CONFLICT).body(ex.getMessage());
    }
